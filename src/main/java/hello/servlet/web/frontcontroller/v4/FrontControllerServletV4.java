...
public class FrontControllerServletV4 extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        final ControllerV4 controller = controllerMap.get(uri);
        if (controller == null) {
        ...
        req.getParameterNames().asIterator().forEachRemaining(param -> {params.put(param, req.getParameter(param));});
        final Map<String, Object> model = new HashMap<>();

        final String viewName = controller.process(params, model);
